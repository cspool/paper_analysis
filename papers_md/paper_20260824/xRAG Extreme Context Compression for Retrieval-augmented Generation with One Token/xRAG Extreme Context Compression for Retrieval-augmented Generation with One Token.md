# <span id="page-0-0"></span>xRAG: Extreme Context Compression for Retrieval-augmented Generation with One Token

Xin Cheng1<sup>∗</sup> Xun Wang<sup>2</sup> Xingxing Zhang<sup>2</sup> Tao Ge<sup>2</sup> Si-Qing Chen<sup>2</sup> Furu Wei<sup>2</sup> Huishuai Zhang1,<sup>3</sup> Dongyan Zhao1,<sup>3</sup>

> <sup>1</sup> Peking University <sup>2</sup> Microsoft <sup>3</sup> National Key Laboratory of General Artificial Intelligence chengxin1998@stu.pku.edu.cn
...
# <span id="page-15-1"></span>**B** Instructions for Paraphrase Pretraining
...
- <span id="page-15-3"></span>• "Background: [X] means the same as [D] "
...
- "[X] After uppacking the ideas in the background information above, we got: [D] "
...
Table 6: Instructions used for Paraphrase Pretraining where [X] and [D] are placeholders for projected retrieval feature  $\mathbf{W}(E)$  and document D.
...
Justification: Section [5.1](#page-5-1) and Appendix [G](#page-20-0)
...
Justification: in Appendix [D](#page-17-0) we provide full details about our training process
...
Justification: Section [4.1](#page-4-0)
...
Justification: in Section [5.1](#page-5-1)
...
Justification: in Appendix [D](#page-17-0)
...
Justification: in section [5.2](#page-6-3)
...
Justification: in Section [C](#page-16-0)
