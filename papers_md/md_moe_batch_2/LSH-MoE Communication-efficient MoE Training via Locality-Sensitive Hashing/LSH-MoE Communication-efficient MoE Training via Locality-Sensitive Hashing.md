...
# <span id="page-9-1"></span>6 Limitations
...
Justification: The paper demonstrates the token similarity in Section [3.1,](#page-4-1) introduces the critical residual-based error compensation scheme in Section [3.2,](#page-5-0) and verifies the effectiveness of the method in Section [4.4.](#page-7-1)
...
Justification: The paper discusses the limitations of this work in Section [6](#page-9-1)
...
Justification: The paper provides detailed experimental settings in Section [4.2](#page-6-4) for datasets, Section [4.3](#page-7-2) for environments, and Table [1](#page-6-0) for model hyper-parameters. In addition, we submit our code in the supplementary material along with the paper.
...
Justification: The paper provides detailed information on the computer resources and environments needed to reproduce the experiments in Section [4.3.](#page-7-2)
...
Justification: The creators and original owners of assets used in the paper are properly credited. The paper includes URLs as footnotes for the code base used in the experiments in Section [4.2.](#page-6-4)
