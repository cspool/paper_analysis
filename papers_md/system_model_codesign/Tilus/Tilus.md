# <span id="page-0-0"></span>Tilus: A Tile-Level GPGPU Programming Language for Low-Precision Computation

# [Yaoyao Ding](https://orcid.org/0000-0002-9801-6080)∗†

University of Toronto Toronto, ON, Canada yaoyao@cs.toronto.edu

# [Allan Lin](https://orcid.org/0009-0008-0401-1053)

University of Waterloo Waterloo, ON, Canada a8lin@uwaterloo.ca

# [Bohan Hou](https://orcid.org/0000-0001-5718-3387)

Carnegie Mellon University Pittsburgh, PA, USA bohanhou@andrew.cmu.edu

# [Tianqi Chen](https://orcid.org/0000-0002-5744-3940)<sup>∗</sup>

Carnegie Mellon University Pittsburgh, PA, USA tqchen@cmu.edu

# [Xiao Zhang](https://orcid.org/0009-0000-0914-5669)∗†

University of Toronto Toronto, ON, Canada bohanhou@andrew.cmu.edu

# [Cody Hao Yu](https://orcid.org/0000-0002-9298-6254)

Independent Researcher Santa Clara, CA, USA hao.yu.cody@gmail.com

# [Yida Wang](https://orcid.org/0000-0001-8165-840X)

Amazon Web Services Santa Clara, CA, USA wangyida@amazon.com
...
# [Gennady Pekhimenko](https://orcid.org/0000-0002-3839-0919)∗†

University of Toronto Toronto, ON, Canada pekhimenko@cs.toronto.edu

highly efficient GPU programs through automatic vectorization and instruction selection. Extensive experiments demonstrate that Tilus efficiently supports a full spectrum of lowprecision data types, and outperforms state-of-the-art lowprecision kernels. Compared to existing compilers such as Triton and Ladder, as well as hand-optimized kernels such as QuantLLM and Marlin, Tilus achieves performance improvements of: 1.75×, 2.61×, 1.29× and 1.03×, respectively. We open-source Tilus at <https://github.com/NVIDIA/tilus>.
...
Yaoyao Ding, Bohan Hou, Xiao Zhang, Allan Lin, Tianqi Chen, Cody Hao Yu, Yida Wang, and Gennady Pekhimenko. 2026. Tilus: A Tile-Level GPGPU Programming Language for Low-Precision Computation . In xxx. ACM, New York, NY, USA, [17](#page-16-0) pages. [https:](https://doi.org/10.1145/nnnnnnn.nnnnnnn) [//doi.org/10.1145/nnnnnnn.nnnnnnn](https://doi.org/10.1145/nnnnnnn.nnnnnnn)
