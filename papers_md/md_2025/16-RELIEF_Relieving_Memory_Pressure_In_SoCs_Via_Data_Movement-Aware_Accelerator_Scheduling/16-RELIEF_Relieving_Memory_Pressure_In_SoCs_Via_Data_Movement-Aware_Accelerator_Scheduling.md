...
Sudhanshu Gupta *University of Rochester* sgupta45@cs.rochester.edu Sandhya Dwarkadas *University of Virginia* sandhya@virginia.edu
...
- [4] AMD, "AXI4-Stream Infrastructure IP Suite v3.0," May 2023. [Online]. Available: https://docs.xilinx.com/r/en-US/pg085-axi4streaminfrastructure/AXI4-Stream-Infrastructure-IP-Suite-v3.0-LogiCORE-IP-Product-Guide
...
- [15] J. Cong, M. A. Ghodrat, M. Gill, B. Grigorian, and G. Reinman, "Architecture Support for Domain-Specific Accelerator-Rich CMPs," *ACM Trans. Embed. Comput. Syst.*, vol. 13, no. 4s, Apr. 2014, place: New York, NY, USA Publisher: Association for Computing Machinery. [Online]. Available: https://doi.org/10.1145/2584664
...
- [18] E. Duesterwald, C. Cascaval, and S. Dwarkadas, "Characterizing and predicting program behavior and its variability," in *2003 12th International Conference on Parallel Architectures and Compilation Techniques*, 2003, pp. 220–231.
...
- [32] Q. Liu, "Smooth Stitching Method of VR Panoramic Image Based on Improved SIFT Algorithm," in *Proceedings of the Asia Conference on Electrical, Power and Computer Engineering*, ser. EPCE '22. New York, NY, USA: Association for Computing
...
- [41] M. Ravanelli, P. Brakel, M. Omologo, and Y. Bengio, "Light Gated Recurrent Units for Speech Recognition," *IEEE Transactions on Emerging Topics in Computational Intelligence*, vol. 2, no. 2, pp. 92–102, 2018.
...
- [60] H.-E. Zahaf, N. Capodieci, R. Cavicchioli, M. Bertogna, and G. Lipari, A C-DAG task model for scheduling complex real-time tasks on heterogeneous platforms: preemption matters. arXiv, 2019, arXiv preprint: 1901.02450.
...
- 3) Set M5\_PATH environment variable: export M5\_PATH=`pwd`
...
./create\_binary\_combinations\_3.sh
...
<sup>&</sup>lt;sup>2</sup>https://github.com/Sacusa/gem5-SALAM/tree/HPCA\_2024

<sup>&</sup>lt;sup>3</sup>https://doi.org/10.5281/zenodo.10237117

#### *E. Experiment workflow*

Navigate to the project root directory and launch high contention scenario simulations by running:

./run\_combinations\_3.sh `nproc`

The simulations need at least 10 cores to finish in a reasonable period. The results will be saved in the directory \$M5\_PATH/BM\_ARM\_OUT/comb\_3.

## *F. Evaluation and expected results*

We provide five scripts in \$M5\_PATH/BM\_ARM\_OUT/scripts/comb\_3: plot\_forwards.py, plot\_data\_movement.py, plot\_accelerator\_occupancy.py, plot\_slowdown.py, and plot\_deadlines\_met.py, that reproduce Figures 4c, 5c, 7c, 9a, and 8c, respectively. The last script also reproduces 9b. Each script can be run as:

python <script>

The scripts use matplotlib to produce the figures in PDF format, which are stored in \$M5\_PATH/BM\_ARM\_OUT/scripts/plots.
