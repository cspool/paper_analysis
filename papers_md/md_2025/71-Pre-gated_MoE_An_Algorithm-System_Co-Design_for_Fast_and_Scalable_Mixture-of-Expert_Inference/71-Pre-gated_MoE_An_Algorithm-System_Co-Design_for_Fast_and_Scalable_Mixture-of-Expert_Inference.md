...
- [10] E. Frantar, S. Ashkboos, T. Hoefler, and D. Alistarh, "OPTQ: Accurate Quantization for Generative Pre-trained Transformers," in *Proceedings of the International Conference on Learning Representations (ICLR)*, 2023.
...
- [26] OpenAI, "Introducing ChatGPT," https://openai.com/blog/chatgpt, 2022. [27] D. Patterson, J. Gonzalez, Q. Le, C. Liang, L.-M. Munguia, D. Rothchild, D. So, M. Texier, and J. Dean, "Carbon Emissions and
...
- [30] S. Rajbhandari, C. Li, Z. Yao, M. Zhang, R. Y. Aminabadi, A. A. Awan, J. Rasley, and Y. He, "DeepSpeed-MoE: Advancing Mixtureof-Experts Inference and Training to Power Next-Generation AI Scale," in *Proceedings of the International Conference on Machine Learning (ICML)*, 2022.
...
- Mixture-of-Experts Distributed Training and Inference System," in *arxiv.org*, 2023.
- [39] M. Shoeybi, M. Patwary, R. Puri, P. LeGresley, J. Casper, and B. Catanzaro, "Megatron-LM: Training Multi-Billion Parameter Language Models Using Model Parallelism," in *arxiv.org*, 2020.
...
- [45] M. Zhai, J. He, Z. Ma, Z. Zong, R. Zhang, and J. Zhai, "SmartMoE: Efficiently Training Sparsely-Activated Models through Combining Offline and Online Parallelization," in *Proceedings of the USENIX Annual Technical Conference (ATC)*, 2023.
...
- 1) How to access: The artifact is available in archival repositories on Zenodo and GitHub.
  ...
  - GitHub: https://github.com/ranggihwang/Pregated\_MoE
...
- Launch a Docker container using the following command, replacing \${DATA\_PATH} with the path to your model preparation directory:
...
cmake -DSUILD_PYT=ON -DBUILD_MULTI_GPU=ON ..
make -i
```
...
The script will generate output files in CSV format including block\_lats.csv, throughputs.csv and peak\_mems.csv, which contain data on MoE block latencies, inference throughputs, and peak memory usage, respectively. The results are shown in Figure 10, Figure 11, and Figure 12.
