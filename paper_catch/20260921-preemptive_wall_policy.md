...
## 已去重（本地已有，未列入）：μShare（experiment_notes 66）、Autellix/Agentix（paper_secs/paper_20260824）
...
- [XSched: Preemptive Scheduling for Diverse XPUs](https://www.usenix.org/conference/osdi25/presentation/shen-weihang)
