...
CONFIGS = [
    {
        "name": "effAttn",
        "paper_base_dir": ROOT / "papers_md" / "md_effAttn",
        "log_dir": ROOT / "outputs" / "logs_effAttn",
        "status_dir": ROOT / "outputs" / "status_effAttn",
        "progress_file": ROOT / "outputs" / "progress_effAttn.json",
        "experiment_dir": ROOT_REPO / "repo_effAttn" / "experiment_repo",
        "idea_dir": ROOT_REPO / "repo_effAttn" / "idea_repo",
        "knowledge_dir": ROOT_REPO / "repo_effAttn" / "knowledge_repo",
    },
    {
        "name": "rtrans_ssm",
        "paper_base_dir": ROOT / "papers_md" / "md_rtrans_ssm",
        "log_dir": ROOT / "outputs" / "logs_md_rtrans_ssm",
        "status_dir": ROOT / "outputs" / "status_md_rtrans_ssm",
        "progress_file": ROOT / "outputs" / "progress_md_rtrans_ssm.json",
        "experiment_dir": ROOT_REPO / "repo_md_rtrans_ssm" / "experiment_repo",
        "idea_dir": ROOT_REPO / "repo_md_rtrans_ssm" / "idea_repo",
        "knowledge_dir": ROOT_REPO / "repo_md_rtrans_ssm" / "knowledge_repo",
    },
    {
        "name": "video_image",
        "paper_base_dir": ROOT / "papers_md" / "md_video_image",
        "log_dir": ROOT / "outputs" / "logs_video_image",
        "status_dir": ROOT / "outputs" / "status_video_image",
        "progress_file": ROOT / "outputs" / "progress_video_image.json",
        "experiment_dir": ROOT_REPO / "repo_video_image" / "experiment_repo",
        "idea_dir": ROOT_REPO / "repo_video_image" / "idea_repo",
        "knowledge_dir": ROOT_REPO / "repo_video_image" / "knowledge_repo",
    },
]
...
def run_config(config):
    ...
    # Summary
    # Only count papers that failed AND were never successfully retried
    done_set = set(progress.get("done", []))
    failed_paper_keys = {entry["paper"] for entry in progress.get("failed", [])}
    truly_failed = failed_paper_keys - done_set
    return {
        "config": config_name,
        "total": total,
        "done": len(done_set),
