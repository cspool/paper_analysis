...
> LV-Eval:multifieldga LV-Eval:loogle-SD LongBench:QMSum LongBench: Musique √
> √
> √
> √
> √
...
> √
> √
> √ LLM-7B-32K LLM-7B-128K-GOA LLM-72B-32K LLM-72B-128K-GQA 2000 1000 500 Baseline Baseline +TCP +TCP +TCP Baseline +TCP +TCP +TCP Baseline +TCP (CENT) +DCS (CENT) +DCS (CENT) +DCS +DCS (CENT) +DCS +DCS +DCS +DPA +DPA +DPA +DPA
...
> LV-Eval:multifieldga LV-Eval:loogle-SD LongBench:QMSum LongBench:Musique LLM-7B-32K LLM-7B-128K-GQA LLM-72B-32K LLM-72B-128K-GQA 2000 1000 -+TCP +TCP +TCP Baseline +TCP +TCP +TCP Baseline +TCP +TCP +TCP Baseline +TCP +TCP +TCP Baseline (NeuPIMs) +DCS +DCS +DCS (NeuPIMs) +DCS +DCS (NeuPIMs) +DCS +DCS (NeuPIMs) +DCS +DPA +DPA +DPA +DPA
...
> LLM-7B-32K LLM-7B-128K-GQA 2500 tokens/s) CENT CENT+TCP+DCS CENT+TCP CENT+TCP+DCS+DPA 2000 1500 Throughput 1000 500 0 (8,1)(4,2)(2,4)(1,8)(8,1)(4,2)(1,8)
