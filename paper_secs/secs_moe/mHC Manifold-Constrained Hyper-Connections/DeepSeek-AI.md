...
|-------------|-------------------------------------------------------------------------------------------------------------|----------------------|----------------------|--|
| Residual    | Residual Merge                                                                                              | 2 <i>C</i>           | С                    |  |
...
$$\mathcal{H}_l^{\text{post}}$$
: float32 =  $2\sigma\left(\tilde{\mathcal{H}}_l^{\text{post}}\right)$  (18)
