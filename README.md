...
这个仓库不是“把一篇论文总结一下”的脚本集合，而是一条可复用的研究工作流：从标题下载论文，转换和拆分正文，抽取实验、Idea 与术语知识，再通过 Obsidian 本地知识库和**伪代码式 Agent 编排（弥补DS4P的tool use和长上下文能力不足）**，对指定主题做可追溯的学习与价值 Review。
